...
const kataria1: TranscriptJson = {
  ...
  lines: [
    ...
    {
      name: SAMSON,
      text: "Mr. Kataria, do you know the current whereabouts of all your children?",
    },
    {
      name: KATARIA,
...
const kataria2: TranscriptJson = {
  ...
  lines: [
    ...
    { name: KATARIA, text: "Wait, let me call David on my other phone." },
    { name: SAMSON, text: "Of course." },
    {
      name: KATARIA,
      text: "(AFTER SEVERAL MINUTES OF SILENCE) He's not picking up!",
    },
    {
      name: SAMSON,
    ...
    {
      name: SAMSON,
      text: "I'm not sure, Mr. Kataria. I'm trying to figure that out right now.",
    },
...
const larssen1: TranscriptJson = {
  ...
  lines: [
    ...
    {
      name: SAMSON,
      text: "Just standard procedure, ma'am. I have to follow protocol.",
    },
    {
      name: LARSSEN,
      text: "Does your protocol involve actually doing your job?",
    },
    {
      name: SAMSON,
...
const larssen2: TranscriptJson = {
  ...
  lines: [
    ...
    {
      name: LARSSEN,
      text: "Well, no, but I'm sure these friends of his are up to no good.",
    },
    {
      name: SAMSON,
