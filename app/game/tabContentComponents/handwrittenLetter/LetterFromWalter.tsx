...
export default function LetterFromWalter() {
  const lines1 = [
    ...
    "I hope this letter finds you well. I want to first  to express my gratitude for the love and care you have shown to my son, Gregory. Your presence in his life has brought him immense joy and happiness, and for that, I am truly thankful.",
    ...
    "My son has committed the sin of infedelity against you. It happened about two years into your courtship when the two of you still resided in Berkshire. The other woman became pregnant and gave birth to a boy. Against my better judgement, I assisted my son in covering up this transgression and sent the woman and her child away. You were none the wiser. After you and Gregory moved abroad, Gregory began sending me money under the guise of paying for his mother's medical care. In reality, much of the funds were used to support his illegitimate son.",
  ];
