...
export default function LetterFromWalter() {
  const lines1 = [
    ...
    "I hope this letter finds you well. I want to first express my gratitude for the love and care you have shown to my son. Your presence in his life has brought him immense joy and happiness, and for that, I am truly thankful.",
